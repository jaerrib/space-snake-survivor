...
enum ProjectileType { SNAKE_PROJECTILE_1, BLAST_RADIUS, SNAKE_MISSILE, SNAKE_BOMB, BOMB_RADIUS }

enum PlayerWeapons { ATTACK_1, ATTACK_2, ATTACK_3, ATTACK_4 }
